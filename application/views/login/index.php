...
<head>
	...
	<title>Foxcarga | Inicio de sesión</title>
							...
							<div class="col-xs-12">
								<form  method="post" action="<?php echo base_url() ?>login/process">
									...
									<div class="form-group">
										<input type="text" class="form-control" name="data[usuario]" placeholder="Correo electrónico" required="required" />
									</div>
									<div class="form-group">
										<input type="password" class="form-control" name="data[password]" placeholder="Contraseña" required="required" />
									</div>
									<div class="form-group">
										<button id="btn-login" type="submit" class="btn btn-primary" style="">
											<i class="fa fa-sign-in" aria-hidden="true"></i>&nbsp;Iniciar sesión</button>
									</div>
									<br>
									<div class="form-group">
										<a href="<?php echo base_url() ?>RecuperarContrasena/index">
											¿Olvidó la contraseña?
										</a>
									</div>
									<a class="form-group" href="<?php echo base_url() ?>registro">
										¿Nuevo en el sitio?
										<b>
											¡Regístrate!
										</b>
